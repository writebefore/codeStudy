          ...
          <cube-scroll-nav-bar direction="vertical"
           ...
           :txts="barTxts">
            ...
            <template slot-scope="props">
                <div class="text">
                    <support-ico v-if="props.txt.type >= 0"
                      :size=3 :type="props.txt.type"></support-ico>
                    <span>{{props.txt.name}}</span>
                </div>
            </template>
          </cube-scroll-nav-bar>
        </template>
        <cube-scroll-nav-panel v-for="good in goods" :key="good.name"
        :label="good.name" :title="good.name">
          <ul>
