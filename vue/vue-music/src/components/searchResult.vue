<template>
  <v-scroll ref="suggest" class="suggest" :data="result" :pullup="pullup" :beforeScroll="beforeScroll" @scrollToEnd="scrollEnd">
    <ul class="suggest-list">
      <li class="suggest-item" v-for="(item, index) in result" :key="index">
        ...
        <div class="name">
          <p class="text" v-html="getDisplayName(item)" @click="selectItem(item)"></p>
        </div>
      </li>
    </ul>
  </v-scroll>
